# Slurm script to perform 3 year spinup, then save initial conditions 
# 10 days apart over 30 years climatology.
...
def init_and_clim(soil_conf, rad_conf):
    ...
    with gzip.open('initial_'+str(soil_conf)+'_'+str(rad_conf)+'/new_world_'+str(soil_conf)+'_'+str(rad_conf), 'wb') as f:
